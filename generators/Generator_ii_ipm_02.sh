...
PWD=`pwd`
RUNNERS=(runner_II_IPM_02) #Change this
NORMRHS=(1 2 4 8 16 32)
ANCILLAES=(1 2 3 4 5 6 7 8 9)
DIMENSIONS=(10 50 100 200 500 1000) #2 4 6 8 10
...
for seed in {1..100}; do
    for runner in ${RUNNERS[@]}; do
        for param in ${DIMENSIONS[@]}; do #Change this
        	DIRC="/home/quantum/interior_point_methods/results/II_IPM_var_num" #Change this
        	mkdir -p ${DIRC}
