...
summary 	= ["File name", "Seed", "Number of variables", "Number of constraints", "Norm of vector b", "Norm of matrix A", "Condition number", "Optimal objective", "Primal objective", "Dual objective", "Primal residual", "Dual residual", "Complementraty", "Number of Iter", "Run time"]
